...
La descomposici\'on aleatoria--epist\'emica revela que, en este
...
Las principales limitaciones del estudio son la naturaleza local y unimodal
de la aproximaci\'on gaussiana de Laplace, la restricci\'on a la \'ultima
capa, la elecci\'on manual del \texttt{DROPOUT\_RATE} en MC Dropout, y
